...
n.sv2 = num.sv(log_gfpkm_sva, mod2, method = "be", B = 5)
#n.sv_adj

svobj2 = sva(log_gfpkm_sva, mod2, mod0, n.sv=n.sv2, B = 5)
...
```{r}
mod03 = model.matrix(~as.factor(group), data=phenDat) 
mod3 = mod2 
svobj3 = sva(log_gfpkm_sva, mod3, mod03) 
plot(svobj3$sv)
```
...
mod4 = model.matrix(~as.factor(treatment) + 
                    ...
                    data=phenDat)
mod04 = mod0
n.sv4 = num.sv(nolog_gfpkm_svaseq, mod4, method = "be", B = 5)
svaseq4 = svaseq(nolog_gfpkm_svaseq, mod4, mod04, n.sv = n.sv4)
```
