...
log_gfpkm_all <- read.csv("../processed/results/ballG_all_results/log_gfpkm_all.csv",
...
nolog_gfpkm_all <- read.csv("../processed/results/ballG_all_results/nolog_gfpkm_all.csv",
                    stringsAsFactors = FALSE)
...
# models
svaseqobj <- svaseq(nolog_gfpkm_svaseq, mod, mod0 , n.sv=n.sv, controls = NULL,
