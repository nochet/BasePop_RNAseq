---
title: "Global trends analysis of RNA-seq for base population"
author: "Enoch Ng'oma"
date: "May 5, 2018"
...
save(gfpkm_bg_diff, file = "../processed/results/ballG_all_results/gfpkm_bg_ballG_filt_heat.Rda")
```
...
ggplot(pc.dat, aes(x=PC1, y=PC2, col=Diet, label=name)) + 
        geom_point() + 
        theme_bw() +
