...
```{r}
results_heads_transcripts <- stattest(bg_heads_filt, feature="transcript",covariate="treatment", meas="FPKM")
results_soma_transcripts <- stattest(bg_soma_filt, feature="transcript",covariate="treatment", meas="FPKM")
results_ovaries_transcripts <- stattest(bg_ovaries_filt, feature="transcript",covariate="treatment", meas="FPKM")
```
...
```{r}
results_heads_transcripts <- data.frame(geneNames=ballgown::geneNames(bg_heads_filt), geneIDs=ballgown::geneIDs(bg_heads_filt), results_heads_transcripts)

results_soma_transcripts <- data.frame(geneNames=ballgown::geneNames(bg_soma_filt), geneIDs=ballgown::geneIDs(bg_soma_filt), results_soma_transcripts)

results_ovaries_transcripts <- data.frame(geneNames=ballgown::geneNames(bg_ovaries_filt), geneIDs=ballgown::geneIDs(bg_ovaries_filt), results_ovaries_transcripts)
```
