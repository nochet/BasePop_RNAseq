...
write.csv(fc.kegg, "../../processed/DESEQ/pathway_enrich.csv")

write.csv(rbind(fc.kegg$greater, fc.kegg$less),
     "../../processed/DESEQ/pathway_enrich.csv")
...
# gots <- go_sets[[1]]
# gqval05_gots <- gqval05[,"goterm"]
# gqval05_goterms <- gots[gqval05_gots]
# 
# gqval05_goterms <- do.call(rbind.data.frame, gqval05_goterms)
# gqval05_goterms <- data.frame(sapply(gqval05_goterms,c))
# gqval05_goterms <- data.frame(Reduce(rbind, gqval05_goterms))
