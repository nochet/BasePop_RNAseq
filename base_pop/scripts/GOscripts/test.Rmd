...
# Save to use with EnrichmentBrowser later
#save(lrt.treatAll, file="../../processed/DESEQ/GO/lrt.treatAll.Rda")
```
...
head(keggres$greater[, 1:5], 4)
head(keggres$stats[,1:2], 4)
...
keggres.sig<-sigGeneSet(keggres, outname="keggres")
# curious!!!
```
