...
load(file="../../processed/DESEQ/dds.02.Rda")
...
ww <- which(rownames(dds.02)==gg[jj])

d <- plotCounts(dds.02, gene=ww, intgroup=c("treatment", "tissue"), 
                returnData=TRUE)
...
ggsave(pall, filename = "../../plots/Interaction_ex.pdf", height = 8, width=10)
```
