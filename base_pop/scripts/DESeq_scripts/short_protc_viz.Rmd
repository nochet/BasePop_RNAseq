...
#save(rlog.01, file = "../../processed/DESEQ/rlog_dds_deseq.01.Rda")
#save(rlog.02, file = "../../processed/DESEQ/rlog_dds_deseq.02.Rda")
write.table(assay(rlog.01), 
            file="../../processed/DESEQ/rlog.01.txt", 
            sep="\t")

load("../../processed/DESEQ/rlog_dds_deseq.01.Rda")
load("../../processed/DESEQ/rlog_dds_deseq.02.Rda")
