...
ll <- ggplot(uncor.pca, aes(PC1, PC2, color=treatment, shape=tissue)) +
  ...
  coord_fixed() +
  my_theme
ll + labs(color="Treatment", shape="Tissue")

ggsave(ll,file = "../../plots/PCAplot_rlog_uncorrected_trt.pdf",width = 5,height=5)
...
gg <- ggplot(bcor.pca, aes(PC1, PC2, color=treatment, shape=tissue)) + 
  ...
  coord_fixed() +
  my_theme
gg + labs(color="Treatment", shape="Tissue")    

ggsave(gg,file = "../../plots/PCAplot_rlog_trt_corrected.pdf",width = 5,height=5)
```
