...
ggsave(plot=b1,filename = "../../plots/Expression_54_barplot.pdf",width = 5,height=5)
...
ggsave(plot=b2,filename = "../../plots/Expression_54_barplot_b2.pdf",width = 3.5,height=3)
```
...
min(full_table.bg$length)
max(full_table.bg$length)
```
