...
names(tab)
write.table(tab, file = "../../processed/DESEQ/Coexpression/resampMods/GOEnrichTab_Resamp.csv", 
...
# Enrichment table
screenTab
write.table(screenTab, file = "../../processed/DESEQ/Coexpression/minMod30/GOEnrichTab_Resamp_simple.txt",
              sep = ",", quote = TRUE, row.names = FALSE)
```
