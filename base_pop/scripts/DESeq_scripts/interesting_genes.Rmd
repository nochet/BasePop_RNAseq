...
1. 1 gene related to Indy: hairy (h). Note, a separate gene Hairless (H) also exists
...
write.csv(candidates, file = "../../processed/DESEQ/cand_genes.csv" )
```

60 hits in DEGs (i.e. 50 unique genes)
