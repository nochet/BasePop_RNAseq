...
# Needed for GO
write.csv(rmat, file = "../../processed/DESEQ/rlogtrt.csv", row.names = TRUE)
```
...
plotDendroAndColors(geneTree, 
                    ...
                    main = NULL,groupLabels = mergedColors,
                    dendroLabels= FALSE, hang=0.03, 
...
table(mergedColors, moduleColors)
...
# Write module names for GO analysis later
...
# Module membership (aka. module eigengene based connectivity kME)
