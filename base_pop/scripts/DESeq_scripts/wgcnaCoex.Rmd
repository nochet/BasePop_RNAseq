...
# rlog transform exprs data: design ~ SV1+batch

```{r}
load("../../processed/DESEQ/dd0.wg.Rda")
rlog.wg0 <- rlog(dd0.wg, blind = FALSE, fitType = "parametric")
...
# Compare with rlog of DESeq full model ~ SV1+batch+tissue+treatment
...
phen.bin1 = binarizeCategoricalVariable(phenDat1,
