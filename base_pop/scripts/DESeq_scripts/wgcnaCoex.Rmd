...
rlog.wg0 <- rlog(dds_deseq.01, blind = FALSE, fitType = "parametric")
vst.wg0 <- varianceStabilizingTransformation(dds_deseq.01,
                                            blind = FALSE, fitType = "parametric")
# Save transformed data
save(rlog.wg0, file="../../processed/DESEQ/rlog.wg0.Rda")
save(vst.wg0, file="../../processed/DESEQ/vst.wg0.Rda")

load("../../processed/DESEQ/vst.wg0.Rda")
load("../../processed/DESEQ/rlog.wg0.Rda")
...
#             file="../../processed/DESEQ/rlog.wg0.txt", sep="\t")
# 
# write.table(assay(vst.wg0),
#             file="../../processed/DESEQ/vst.wg0.txt", sep="\t")
...
# vst data
mat <- assay(vst.wg0)
mat <- limma::removeBatchEffect(mat, batch = phenDat.sva$SV1, batch2 = phenDat.sva$batch)
assay(vst.wg0) <- mat
print(plotPCA(vst.wg0, intgroup=c("treatment", "tissue"), returnData=FALSE))

# rlog data
rmat <- assay(rlog.wg0)
rmat <- limma::removeBatchEffect(mat, batch = phenDat.sva$SV1, batch2 = phenDat.sva$batch)
assay(rlog.wg0) <- rmat
print(plotPCA(rlog.wg0, intgroup=c("treatment", "tissue"), returnData=FALSE))
...
```{r}
rlogtrt <- read.table("../../processed/DESEQ/rlog.wg0.txt", sep="\t")
