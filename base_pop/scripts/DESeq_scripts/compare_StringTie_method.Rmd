...
cdat1 <- read.csv("../../processed/gene_count_matrix_pl3c.csv", stringsAsFactors = FALSE)
...
cdat2 <- read.csv("../../processed/Old-gene_count_matrix.csv", row.names="gene_id")

cdat3 <- read.csv("../../processed/S03_short_ballG/gene_count_matrix.csv", row.names="gene_id")
