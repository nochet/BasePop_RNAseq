...
save(out.dat, file="../../processed/DESEQ/Coexpression/Resample_WGCNA_mods.rda")
save(ME.list, file="../../processed/DESEQ/Coexpression/Resample_WGCNA_eigen.rda")
...
write.csv(elim, file="../../processed/DESEQ/Coexpression/Resamp_droppedGenes.csv", row.names=FALSE)
