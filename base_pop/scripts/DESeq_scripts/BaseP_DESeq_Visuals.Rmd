...
```{r}
vizDE <- read.csv("../../processed/DESEQ/normExpr_countData.csv")
vizDE <- read.csv("../../processed/S03_short_ballG/gene_count_matrix.csv")

phenDat <- read.csv("../../processed/phenotypes.csv")
