...
fcplot <- plot_grid(pp.list[[1]], pp.list[[2]], pp.list[[3]],nrow=1,labels = c('a.', 'b.', 'c.'), align = 'h',rel_widths = c(1.2,1,1.9), label_size = 10)
fcplot
...
#ggsave(vocplot, file="../../plots/Voc_all.pdf",width=6.5,height=5)
