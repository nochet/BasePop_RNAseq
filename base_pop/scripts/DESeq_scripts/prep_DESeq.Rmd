...
# pairwise comparisions (treatment effect)
...
HBvQTL$analysis <- rep("HBvQTL",length(HBvQTL))
#write.csv(HBvQTL, 
          #"../../processed/DESEQ/DEG_QTL/sigDEGs_int_HBvQTL.csv")

# DEG table, interaction O vs B
OB.int_table <- as.data.frame(resSig_OB)
OBvQTL <- OB.int_table %>%
      filter(Gene %in% iis.qtl$fbgn_id)  
OBvQTL$analysis <- rep("OBvQTL",length(OBvQTL))
write.csv(OBvQTL, "../../processed/DESEQ/DEG_QTL/sigDEGs_int_OBvQTL.csv")

# DEG table, interaction O vs H
OH.int_table <- as.data.frame(resSig_OH)
OHvQTL <- OH.int_table %>%
      filter(Gene %in% iis.qtl$fbgn_id)  
OHvQTL$analysis <- rep("OHvQTL",length(OHvQTL))
write.csv(OHvQTL, "../../processed/DESEQ/DEG_QTL/sigDEGs_int_OHvQTL.csv")
```
...
CDRvQTL <- CDR.int_table %>%
      filter(Gene %in% iis.qtl$fbgn_id)                      
write.csv(CDRvQTL, 
          "../../processed/DESEQ/DEG_QTL/sigDEGs_int_CDRvQTL.csv")
...
write.csv(down_CDRvQTL, 
          "../../processed/DESEQ/DEG_QTL/sigDEGs_int_down_CDRvQTL.csv")

# DEG table, interaction C vs HS
CHS.int_table <- as.data.frame(resSig_CHS)
CHSvQTL <- CHS.int_table %>%
      filter(Gene %in% iis.qtl$fbgn_id)                      
write.csv(CHSvQTL, "../../processed/DESEQ/DEG_QTL/sigDEGs_int_CHSvQTL.csv")

up_CHSvQTL <- subset(CHSvQTL, log2FoldChange > 0)
down_CHSvQTL <- subset(CHSvQTL, log2FoldChange < 0)
write.csv(up_CHSvQTL, 
          "../../processed/DESEQ/DEG_QTL/sigDEGs_int_up_CHSvQTL.csv")
write.csv(down_CHSvQTL, 
          "../../processed/DESEQ/DEG_QTL/sigDEGs_int_down_CHSvQTL.csv")

# DEG table, interaction DR vs HS
DRHS.int_table <- as.data.frame(resSig_DRHS)
DRHSvQTL <- DRHS.int_table %>%
      filter(Gene %in% iis.qtl$fbgn_id)                      
write.csv(DRHSvQTL, "../../processed/DESEQ/DEG_QTL/sigDEGs_int_DRHSvQTL.csv")

up_DRHSvQTL <- subset(DRHSvQTL, log2FoldChange > 0)
down_DRHSvQTL <- subset(DRHSvQTL, log2FoldChange < 0)
write.csv(up_DRHSvQTL, 
          "../../processed/DESEQ/DEG_QTL/sigDEGs_int_up_DRHSvQTL.csv")
write.csv(down_DRHSvQTL, 
          "../../processed/DESEQ/DEG_QTL/sigDEGs_int_down_DRHSvQTL.csv")
