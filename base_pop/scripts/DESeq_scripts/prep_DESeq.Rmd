...
write.csv(resSig_lrt.int, "../../processed/DESEQ/DEGs_lrt.int_0.05.csv", row.names=TRUE)
...
write.csv(resSig_lrt.tissue, "../../processed/DESEQ/DEGs_lrt.tissue_0.05.csv", row.names=TRUE)
...
write.csv(resSig_lrt.treatment, "../../processed/DESEQ/DEGs_lrt.treatment_0.05.csv", row.names=TRUE)
...
write.csv(resSig_HB, "../../processed/DESEQ/DEGs_HB_0.05.csv", row.names=TRUE)
...
write.csv(resSig_OB, "../../processed/DESEQ/DEGs_OB_0.05.csv", row.names=TRUE)
...
write.csv(resSig_OH, "../../processed/DESEQ/DEGs_OH_0.05.csv", row.names=TRUE)
