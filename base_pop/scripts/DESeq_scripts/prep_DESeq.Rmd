...
lrt.tissue <- results(lrt.tissue)

lrt.treatment <- DESeq(dds.01, test="LRT", reduced=~ SV1 + batch + tissue)
lrt.treatment <- results(lrt.treatment)
...
rr1 <- results(dds_deseq.02, contrast=c('tissue', "H","B"))
rr2 <- results(dds_deseq.02, contrast=c('tissue', "O","B"))
rr3 <- results(dds_deseq.02, contrast=c('tissue', "O","H"))
