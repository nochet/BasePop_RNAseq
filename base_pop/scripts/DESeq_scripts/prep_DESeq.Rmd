...
res.dds_body <- res.dds_table[,c(1:9,12,15,18,21,24,27,30,33,36,39,42,45,48,51,54,57,60)]
res.dds_head <- res.dds_table[,c(1:8,10,13,16,19,22,25,28,31,34,37,40,43,46,49,52,55,58,61)]
res.dds_ovary <- res.dds_table[,c(1:8,11,14,17,20,23,26,29,32,35,38,41,44,47,50,53,56,59,62)]
```
