...
#(resOrdered10 <- res.filt10[order(res.filt10$padj), ]) 
#save(resOrdered10, file = "../../processed/DESEQ/resOrdered10.Rda")
...
de_filt5 <- DESeq(ddsDE_filt5)
res.filt5 <- results(de_filt5)
(resOrdered5 <- res.filt5[order(res.filt5$padj), ]) 
save(resOrdered5, file = "../../processed/DESEQ/resOrdered5.Rda")
# still 13 rows not converged
