...
## code runs but burns out: "22 rows did not converge in beta, labelled in mcols(object)$betaConv. Use larger maxit argument with nbinomWaldTest"
```
...
dds <- estimateSizeFactors(dds.ttSS)
