...
save(res.dds, file = "../../processed/DESEQ/DEseq_sva_dds.Rda")
write.csv(res.dds, 
...
write.csv(resOrd_hsint, 
          "../../processed/DESEQ/CvHS_DEseqSVA_int_resOrdered_padj.csv", row.names=TRUE)
```
...
heatmap.2(Matt, trace = "none", col = rev(hmcol), margin=c(13,13))
