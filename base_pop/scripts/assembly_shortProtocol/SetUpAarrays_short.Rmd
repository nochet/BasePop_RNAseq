...
# Run perl step here before proceeding 
# To extract more gene names from STRG ids
```

## Step 4: StringTie merge transcripts from all samples

```{r}
# step skipped in short protocol
# see http://ccb.jhu.edu/software/stringtie/index.shtml?t=manual#de
```
