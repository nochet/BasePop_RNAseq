...
# made by: ballgown_baseP_allTissues-Together.Rmd
...
transcript_fpkm = texpr(bg_ballG_filt, 'FPKM')
...
# how to do this for gexpr()

transcript_fpkm[,c(1:2,57)] # not matching!
```

# Obtain phenotype information for the samples (data frame)

```{r}
pData(bg_ballG_filt) = data.frame(id=sampleNames(bg_ballG_filt), group=rep(c(0,1,2), each=18))
```
